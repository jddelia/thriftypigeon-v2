...
An editorial-first commerce site for actionable money playbooks. This repository houses the Next.js 14 application, Sanity integrations, and adapters for Lemon Squeezy, Resend, Cloudflare R2, and Postgres.
...
- `lib/` – Integrations for Sanity, Lemon Squeezy, email, rate limiting, analytics, and storage helpers.
...
- [ ] Implement Lemon Squeezy webhook normalization and fulfillment email.
